...
lineFile_list = glob.glob(os.path.join(EX_DIR, 'single_transit_route_attribute_change', "*.LIN"))
...
def test_write_transit_standard(request,logfilename):
    ...
    test_project.base_transit_network.write_cube_transit("Z:/Data/Users/Sijia/Met_Council/github/client_met_council_wrangler_utilities/tests/transit_test.lin")
    test_project.write_project_card("Z:/Data/Users/Sijia/Met_Council/github/client_met_council_wrangler_utilities/tests/transit_test.yml")
